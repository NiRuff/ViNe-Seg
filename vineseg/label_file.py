...
#        print(filename)
        ...
        # reopen to write score where missing
        # Step 1: Load the data from the file
        with open(filename, "r") as f:
            data = json.load(f)

        # Step 2: Iterate over the entries and update them
        for shape in data.get("shapes", []):  # This assumes that the 'shapes' key exists in your JSON
